/**
  ******************************************************************************
  * @file    stm8tl5x_flash.h
  * @author  MCD Application Team
  * @version V1.0.1
  * @date    01-March-2012
  * @brief   This file contains all functions prototypes and macros for the FLASH peripheral.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM8TL5X_FLASH_H__
#define __STM8TL5X_FLASH_H__
...
#define FLASH_END_PHYSICAL_ADDRESS    ((uint16_t)0xBFFF)   /*!< Flash: end address */
#define FLASH_BLOCK_NUMBER            ((uint8_t)256)       /*!< Flash memory: total number of Block */
...
@code
 ...
 for more details refer to stm8tl5x_flash.c file.
