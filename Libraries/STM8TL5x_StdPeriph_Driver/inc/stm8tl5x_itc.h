/**
  ...
  * @version V1.0.1
  * @date    01-March-2012
  * @brief   This file contains all functions prototypes and macros for the ITC peripheral.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM8TL5X_ITC_H__
#define __STM8TL5X_ITC_H__
...
typedef enum {
  ...
  PXS_IRQn                      = (uint8_t)2,   /*!< ProxSense interrupt */
