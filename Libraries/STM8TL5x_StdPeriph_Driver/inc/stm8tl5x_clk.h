/**
  ...
  * @version V1.0.1
  * @date    01-March-2012
  * @brief   This file contains all functions prototypes and macros for the CLK peripherals.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM8TL5X_CLK_H
#define __STM8TL5X_CLK_H
...
/**
  ...
  */
typedef enum {
  CLK_Peripheral_TIM2    = (uint8_t)0x00, /*!< Peripheral Clock Enable Register 1, TIM2 */
  CLK_Peripheral_TIM3    = (uint8_t)0x01, /*!< Peripheral Clock Enable Register 1, TIM3 */
  CLK_Peripheral_TIM4    = (uint8_t)0x02, /*!< Peripheral Clock Enable Register 1, TIM4 */
  CLK_Peripheral_I2C     = (uint8_t)0x03, /*!< Peripheral Clock Enable Register 1, I2C */
  CLK_Peripheral_SPI     = (uint8_t)0x04, /*!< Peripheral Clock Enable Register 1, SPI */
  CLK_Peripheral_USART   = (uint8_t)0x05, /*!< Peripheral Clock Enable Register 1, USART */
  CLK_Peripheral_AWU     = (uint8_t)0x06, /*!< Peripheral Clock Enable Register 1, AWU */
  CLK_Peripheral_PXS     = (uint8_t)0x07, /*!< Peripheral Clock Enable Register 1, PXS */
  CLK_Peripheral_WWDG    = (uint8_t)0x10  /*!< Peripheral Clock Enable Register 2, WWDG */
...
#define IS_CLK_PERIPHERAL(PERIPHERAL) \
  (((PERIPHERAL) == CLK_Peripheral_TIM2)  ||\
   ...
   ((PERIPHERAL) == CLK_Peripheral_PXS)   ||\
   ((PERIPHERAL) == CLK_Peripheral_WWDG))
