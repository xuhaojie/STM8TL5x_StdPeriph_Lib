/**
  ...
  * @version V1.0.1
  * @date    01-March-2012
  * @brief   This file contains all functions prototypes and macros for the WFE peripheral.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM8TL5X_WFE_H__
#define __STM8TL5X_WFE_H__
...
typedef enum {
  ...
  WFE_Source_PXS_EV0    = (uint16_t)0x0104, /*!< ProxSense interrupt                     */
